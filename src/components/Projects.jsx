...
import gamesProjects from '../data/gamesProjects';
...
const Projects = () => {
  ...
  const categories = [
    ...
    { id: 'games', name: 'Games', icon: '🎮', count: gamesProjects.length },
  ...
  const renderButtons = (project) => {
    ...
    // Games Projects - Play Game & GitHub
    if (activeTab === 'games') {
      // Kalau ada demo dan github, tampilkan Play Game + Code
        ...
        return (
          <div className="flex gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 text-center px-4 py-2 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg hover:from-orange-600 hover:to-red-700 transition-all text-sm font-medium flex items-center justify-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      // Kalau cuma ada demo tanpa github
      if (project.demo && !project.github) {
        return (
          <a
            href={project.demo}
            target="_blank"
            rel="noopener noreferrer"
            className="w-full text-center px-4 py-2 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg hover:from-orange-600 hover:to-red-700 transition-all text-sm font-medium flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      ...
      // Kalau cuma ada github tanpa demo
      if (!project.demo && project.github) {
        return (
          <a
            href={project.github}
      ...
      // Kalau gak ada demo dan gak ada github (return null atau pesan)
      return null;
    }
    ...
    <section id="projects" className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex bg-gray-900 rounded-xl p-2 border border-gray-700 flex-wrap gap-2">
