        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-gray-400 mb-4 text-lg leading-relaxed">
              I'm a full-stack developer passionate about building functional and beautiful web and 
              mobile applications. I enjoy crafting both the frontend and backend, turning ideas into 
              seamless digital experiences.
            </p>

            <p className="text-gray-400 mb-6 text-lg leading-relaxed">
              Beyond coding, I love exploring new technologies, experimenting with innovative 
              solutions, and sharing insights with the developer community.
            </p>
